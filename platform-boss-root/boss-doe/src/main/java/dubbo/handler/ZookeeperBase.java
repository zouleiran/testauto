...
public class ZookeeperBase {
    ...
    /** zookeeper地址 */
    static final String CONNECT_ADDR = "192.168.1.173:2181";
    /** session超时时间 */
...
//        connectedSemaphore.await();
        ...
        // 获取节点洗信息
//         byte[] data = zk.getData("/com", false, null);
//         System.out.println(new String(data));
//         System.out.println(zk.getChildren("/com", false));
        ...
        // System.out.println(new String(data));
         ...
         //判断节点是否存在
//         System.out.println(zk.exists("/dubbo", false));
        // 删除节点

...
<title>404错误</title>
	<link type="image/x-icon" rel="icon" href="/static/images/home/title.jpg"/>
	<link type="image/x-icon" rel="shortcut icon" href="/static/images/home/title.jpg"/>
<style type="text/css">
html, body {margin:0px;height:100%; font-family:"å¾®è½¯éé»";}
i{ font-style:normal;}
...
.error_new_content { width: 100%; height: 100%; text-align: center; margin: 0 auto; background: url() no-repeat center center; min-width: 1000px; }
...
<div class="error_new_bg pr">
	<div class="error_new_content">
		<div class="error_new pa">
			<div class="fl error_new_left"><img src="/static/images/error/error-1.png"></div>
			<div class="fl error_new_right">
				<p class="mb15"><img src="/static/images/error/error-2.png"></p>
